# BLE Node/Transmitter for Relay Control
...
## Features:
- BLE Transmitter: Sends a unique identifier periodically or when triggered.
...
## Setup
Transmitter:
1. Configure the Unique ID to be sent. This ID is defined in the code as a global variable.
2. Build the transmitter firmware.
3. Power on the transmitter board.
