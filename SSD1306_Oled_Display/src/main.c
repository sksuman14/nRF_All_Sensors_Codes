...
/* Global variable for the text to be displayed */
const char *displayText = "AWaDH";
...
void main(void)
{
    ...
    if (display_set_pixel_format(dev, PIXEL_FORMAT_MONO10) != 0 || cfb_framebuffer_init(dev) != 0)
    {
